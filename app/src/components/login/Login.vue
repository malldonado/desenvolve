          ...
          <div class="col-12 col-md-6 col-xl-7">
            <div class="d-flex justify-content-center text-bg-primary">
              <div class="__left-login-text c col-12 col-xl-9">
                <img class="img-fluid rounded mb-4" loading="lazy" src="../../assets/banner.svg" width="800" height="400" alt="BootstrapBrain Logo">
              </div>
            </div>
          </div>
              ...
              <div class="card-body">
                <div class="row">
                  <div class="col-12">
                    <div class="">
                        <h3>Sign in</h3>
                        <p>Don't have an account? <router-link to="/signup" style="color: black;">Sign up</router-link></p>
                        </div>
                  </div>
                </div>
                  ...
                  <div class="__form-login-sub row gy-3 overflow-hidden">
                    ...
                    <div class="col-12">
                      <div class="form-check">
                        <input v-model="rememberMe" class="form-check-input" type="checkbox" value="" name="remember_me" id="remember_me">
